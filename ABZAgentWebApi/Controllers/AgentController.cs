    ...
    public class AgentController : ControllerBase
    {
        ...
        public async Task<ActionResult> Insert(string token, Agent agent)
        {
            try
            {
                ...
                await client.PostAsJsonAsync("http://localhost:5091/api/QueryResponse/Agent", new { AgentId = agent.AgentID });
               ...
               // await client.PostAsJsonAsync("http://abzcustomerquerywebapi-akshitha.azurewebsites.net/api/QueryResponse/Agent", new { AgentId = agent.AgentID });
